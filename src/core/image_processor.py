...
try:
    ...
    print("✓ MedicalLogger imported successfully")
except ImportError as e:
    ...
    class MedicalLogger:
        def log_system_event(self, *args): pass

        def log_error(self, *args): pass

        def log_file_operation(self, *args): pass

        def log_image_processing(self, *args): pass
...
class ImageProcessor(QObject):
    ...
    def __init__(self, logger: Optional[MedicalLogger] = None):
        ...
        print("Checking SimpleITK availability...")
        if not SIMPLEITK_AVAILABLE:
            print("⚠ SimpleITK not available - DICOM functionality limited")
        else:
            print("✓ SimpleITK available")

        print("Checking VTK availability...")
        if not VTK_AVAILABLE:
            print("⚠ VTK not available - 3D functionality limited")
        else:
            print("✓ VTK available")
        ...
        try:
            ...
            print(f"⚠ Warning during logging: {e}")
